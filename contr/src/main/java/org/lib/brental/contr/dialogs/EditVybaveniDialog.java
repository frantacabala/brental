 ...
 * @author danecek
 */
public final class EditVybaveniDialog extends AbstractBrentalDialog {
    ...
    public EditVybaveniDialog(Vybaveni vyb) {
        ...
        nazev.setText(vyb.getNazev());
        cena_nak = new ValidatedTF(this, 10);
        cena_nak.setText(Integer.toString(vyb.getNakup_cena()));
