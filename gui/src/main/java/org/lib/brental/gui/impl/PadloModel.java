 ...
 * @author john
 */
public class PadloModel extends AbstractTableModel implements Refreshable {

    List<Vybaveni> list = new ArrayList<>();

    public PadloModel(Collection<Vybaveni> c){
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        Padlo r = (Padlo) list.get(rowIndex);
        switch (columnIndex) {
            case 0:
    ...
    public void refresh() throws BRentalException {
       Collection<Vybaveni> rs = BrentalFacadeService.getDefault().getPadla();
